...
<template>
  ...
  <div class="title">
    <h1> 🪴 The Wildflower Way 🪴</h1>
  </div>
  <div class="garden">
    <PlantComponent name="BONZAI" colour="#7F9C72" :imgSrc="plant1" />
    <PlantComponent name="MY BABY ❤️" colour="#A7E45A" :imgSrc="plant2" />
    ...
    <PlantComponent name="007" colour="#D7E0D5" :imgSrc="plant1" />
  </div>
</template>
